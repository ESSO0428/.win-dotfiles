local c = require "user.core.lunar.palette"
...
theme.set_highlights = function()
  ...
  hl(0, "CmpItemKindCopilot", { fg = c.blue, bg = "NONE" })
  hl(0, "CmpItemKindTabnine", { fg = c.teal, bg = "NONE" })
  hl(0, "CmpItemKindCrate", { fg = c.yellow, bg = "NONE" })
  hl(0, "CmpItemKindEmoji", { fg = c.yellow, bg = "NONE" })

  hl(0, "BlinkCmpMenu", { link = "Pmenu" })
  hl(0, "BlinkCmpMenuBorder", { link = "FloatBorder" })
  hl(0, "BlinkCmpMenuSelection", { link = "PmenuSel" })
  hl(0, "BlinkCmpDoc", { link = "CmpDocumentation" })
  hl(0, "BlinkCmpDocBorder", { link = "CmpDocumentationBorder" })
  hl(0, "BlinkCmpLabel", { link = "CmpItemAbbr" })
  hl(0, "BlinkCmpLabelDeprecated", { link = "CmpItemAbbrDeprecated" })
  hl(0, "BlinkCmpLabelMatch", { link = "CmpItemAbbrMatch" })
  hl(0, "BlinkCmpLabelDetail", { link = "CmpItemMenu" })
  hl(0, "BlinkCmpSource", { link = "CmpItemMenu" })
  hl(0, "BlinkCmpKindText", { link = "CmpItemKindText" })
  hl(0, "BlinkCmpKindMethod", { link = "CmpItemKindMethod" })
  hl(0, "BlinkCmpKindFunction", { link = "CmpItemKindFunction" })
  hl(0, "BlinkCmpKindConstructor", { link = "CmpItemKindConstructor" })
  hl(0, "BlinkCmpKindField", { link = "CmpItemKindField" })
  hl(0, "BlinkCmpKindVariable", { link = "CmpItemKindVariable" })
  hl(0, "BlinkCmpKindProperty", { link = "CmpItemKindProperty" })
  hl(0, "BlinkCmpKindClass", { link = "CmpItemKindClass" })
  hl(0, "BlinkCmpKindInterface", { link = "CmpItemKindInterface" })
  hl(0, "BlinkCmpKindStruct", { link = "CmpItemKindStruct" })
  hl(0, "BlinkCmpKindModule", { link = "CmpItemKindModule" })
  hl(0, "BlinkCmpKindUnit", { link = "CmpItemKindUnit" })
  hl(0, "BlinkCmpKindValue", { link = "CmpItemKindValue" })
  hl(0, "BlinkCmpKindEnum", { link = "CmpItemKindEnum" })
  hl(0, "BlinkCmpKindEnumMember", { link = "CmpItemKindEnumMember" })
  hl(0, "BlinkCmpKindKeyword", { link = "CmpItemKindKeyword" })
  hl(0, "BlinkCmpKindConstant", { link = "CmpItemKindConstant" })
  hl(0, "BlinkCmpKindSnippet", { link = "CmpItemKindSnippet" })
  hl(0, "BlinkCmpKindColor", { link = "CmpItemKindColor" })
  hl(0, "BlinkCmpKindFile", { link = "CmpItemKindFile" })
  hl(0, "BlinkCmpKindReference", { link = "CmpItemKindReference" })
  hl(0, "BlinkCmpKindFolder", { link = "CmpItemKindFolder" })
  hl(0, "BlinkCmpKindEvent", { link = "CmpItemKindEvent" })
  hl(0, "BlinkCmpKindOperator", { link = "CmpItemKindOperator" })
  hl(0, "BlinkCmpKindTypeParameter", { link = "CmpItemKindTypeParameter" })
  hl(0, "BlinkCmpKindCopilot", { link = "CmpItemKindCopilot" })
  hl(0, "BlinkCmpKindTabnine", { link = "CmpItemKindTabnine" })
  hl(0, "BlinkCmpKindCrate", { link = "CmpItemKindCrate" })
  hl(0, "BlinkCmpKindEmoji", { link = "CmpItemKindEmoji" })
